  ...
  return (
    <div className="App">
      ...
      <section id="about" className="about">
        ...
        Com mais de 30 anos de experiência, eles capturam emoções e histórias com dedicação e amor em cada clique. 
        Seja em casamentos, aniversários, eventos corporativos ou ensaios especiais, a Foto Real Prudente se compromete a transformar momentos únicos em memórias que durarão para sempre. </p>
