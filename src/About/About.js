...
const About = () => {
    return (
        ...
        <div class="about">
        <h2>Sobre Nós</h2>
        <p>Desde 1994, a <b>Foto Real Prudente</b> vem eternizando momentos inesquecíveis através das lentes apaixonadas de <b>Paulo e Margarida Albino</b>, um casal que faz da fotografia uma verdadeira arte. </p>
